                    ...
                    <div className="section-layout">
                        ...
                        <div className="section-content">
                            <div className="category-card">
                                ...
                                <div className="figures-list">
                                    <div className="figure-card">
                                        <img src="/smg.jpg" alt="司马光" className="figure-image" />
                                    ...
                                    <div className="figure-card">
                                        <img src="/ycl.jpg" alt="于成龙" className="figure-image" />
                                        <div className="figure-content">
                            ...
                            <div className="category-card">
                                ...
                                <div className="figures-list">
                                    <div className="figure-card">
                                        <img src="/bz.jpg" alt="包拯" className="figure-image" />
                                        <div className="figure-content">
                                    ...
                                    <div className="figure-card">
                                        <img src="/hr.jpg" alt="海瑞" className="figure-image" />
                                        <div className="figure-content">
                    ...
                    <div className="section-layout">
                        ...
                        <div className="section-content">
                            <div className="category-card">
                                ...
                                <div className="figures-list">
                                    <div className="figure-card">
                                        <img src="/jyl.jpg" alt="焦裕禄" className="figure-image" />
                                        <div className="figure-content">
                            ...
                            <div className="category-card">
                                ...
                                <div className="figures-list">
                                    <div className="figure-card">
                                        <img src="/ltmt.jpg" alt="李提摩太" className="figure-image" />
                                        <div className="figure-content">
                                    ...
                                    <div className="figure-card">
                                        <img src="/zgf.jpg" alt="赵宗复" className="figure-image" />
                                        <div className="figure-content">
